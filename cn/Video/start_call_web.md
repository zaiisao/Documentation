...
description: 
platform: Web
updatedAt: Mon Sep 23 2019 07:39:20 GMT+0800 (CST)
---
# 实现音视频通话
...
<div class="alert warning">由于浏览器的安全策略限制，Agora Web SDK 仅支持 HTTPS 协议或者 localhost（<code>http://127.0.0.1</code>），请勿使用 HTTP 协议部署你的项目。</div>
