...
description: 
platform: macOS
updatedAt: Tue Jul 14 2020 03:12:10 GMT+0800 (CST)
---
# 实现视频通话
...
<video src="https://web-cdn.agora.io/docs-files/1584929426345" poster="https://web-cdn.agora.io/docs-files/1594697609440"   controls width = 100% height = auto>你的浏览器不支持 <code>video</code> 标签。</video>
...
- `token`：传入能标识用户角色和权限的 Token。可设为如下一个值：
  ...
  -  在你的服务器端生成的 Token。在安全要求高的场景下，我们推荐你使用此种方式生成的 Token，详见[生成 Token](../../cn/Video/token_server_cpp.md)。
