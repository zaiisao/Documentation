...
description: 
platform: Android
updatedAt: Fri Sep 28 2018 18:16:47 GMT+0800 (CST)
---
# 自定义视频源和渲染器
# 自定义视频源和渲染器
...
详见 [设置开发环境](../../cn/Quickstart%20Guide/android_video.md) 。
...
声网 Agora 目前提供自定义视频源及渲染器的示例程序，请前往 [https://github.com/AgoraIO/Agora-Custom-Media-Device-Android](https://github.com/AgoraIO/Agora-Custom-Media-Device-Android) 自行下载并体验。
