...
- 如需调用本方法，请在调用 [sharedEngineWithAppId](https://docs.agora.io/cn/Video/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/sharedEngineWithAppId:delegate:) 方法初始化 AgoraRtcEngineKit 对象后立即调用，否则可能造成输出日志不完整。
