...
description: 
platform: iOS
updatedAt: Tue Jul 14 2020 03:11:52 GMT+0800 (CST)
---
# 实现视频通话
...
<video src="https://web-cdn.agora.io/docs-files/1584608104188" poster="https://web-cdn.agora.io/docs-files/1594697609440"   controls width = 100% height = auto>你的浏览器不支持 <code>video</code> 标签。</video>

<div class="alert note">视频中展示的 UI 可能有部分调整更新，请以当前最新版为准。</div>

## 示例项目

Agora 在 GitHub 上提供开源的实时视频通话示例项目 [Agora-iOS-Tutorial-Objective-C-1to1](https://github.com/AgoraIO/Basic-Video-Call/tree/master/One-to-One-Video/Agora-iOS-Tutorial-Objective-C-1to1) 或 [Agora-iOS-Tutorial-Swift-1to1](https://github.com/AgoraIO/Basic-Video-Call/tree/master/One-to-One-Video/Agora-iOS-Tutorial-Swift-1to1)。在实现相关功能前，你可以下载并查看源代码。
...
- token: 传入能标识用户角色和权限的 Token。你可以设置如下值：
	...
	- 你的服务器端生成的正式 Token。适用于对安全要求较高的生产环境，详情见[生成 Token](../../cn/Video/token_server_cpp.md)。
