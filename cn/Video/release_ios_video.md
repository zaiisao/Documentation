...
| [removePublishStreamUrl](../../cn/Video/release_ios_video.md)  | `url`：字符长度不得超过 **1024** 字节                        |
...
为提升美颜效果，该版本结合主观测试的结果，对美颜选项 [AgoraBeautyOptions](https://docs.agora.io/cn/Video/API%20Reference/oc/Classes/AgoraBeautyOptions.html) 类中的各参数添加了默认值；同时，该版本优化了美颜算法的性能。声网实验室报告显示，优化后的算法下，GPU 消耗、CPU 消耗和功耗均有不同程度的下降。
