...
platform: Web
updatedAt: Mon Mar 25 2019 09:53:19 GMT+0800 (CST)
---
# 加入频道
...
- `tokenOrKey`：如果安全要求不高，将参数值设为 null；如果安全要求高，传入从你的服务端获得的 Token。正式生产环境下，我们推荐你使用 Token。详情参考 [校验用户权限](../../cn/Video/token.md)。
- `channel`：频道名称。
