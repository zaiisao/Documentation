...
- [`AgoraRTC.getSupportedCodec`](https://docs.agora.io/cn/Video/API%20Reference/web/v2.6/globals.html?transId=2.6#getsupportedcodec)
...
- [`Client.on`](https://docs.agora.io/cn/Video/API%20Reference/web/v2.6/interfaces/agorartc.client.html?transId=2.6#on) 新增以下事件：
  - `stream-fallback`
  - `stream-updated`

#### 修改

- [`Stream.startAudioMixing`](https://docs.agora.io/cn/Video/API%20Reference/web/v2.6/interfaces/agorartc.stream.html?transId=2.6#startaudiomixing) 增加 `cacheResource` 参数
