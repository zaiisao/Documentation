...
description: 
platform: Python
updatedAt: Mon Nov 18 2019 06:17:29 GMT+0800 (CST)
---
# 在服务端生成 Token
...
4. 用你自己的 App ID、App 证书以及 Channel Name 替换实例代码中的伪码。关于如何获取 App ID 和 App Certificate，详见 [校验用户权限](https://docs.agora.io/cn/Agora%20Platform/token?platform=All%20Platforms#app-id)
