...
platform: CPP
updatedAt: Thu Dec 20 2018 07:45:33 GMT+0000 (UTC)
---
# 集成录制 SDK
...
1. 请确保你已经集成所需平台的 Agora Native/Web SDK。

2. [下载](https://docs.agora.io/cn/Agora%20Platform/downloads)最新的 Agora 录制 SDK 软件包到你的 Linux 服务器。软件包内容如下:
...
1. 打开 TCP 端口：1080、8000。

2. 打开 UDP 端口：双向 1080、4000-4030、8000、9700、25000 和 所有的录制进程所使用的单向下行端口。
...
3. 将域名 .agora.io、vocs.agora.io、qoslbs.agora.io、qos.agora.io 设为白名单。
4. 安装编译器: gcc 4.4+ 。
5. 请准备所需库：
