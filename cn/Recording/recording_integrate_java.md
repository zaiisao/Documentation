...
platform: Linux Java
updatedAt: Mon Jun 01 2020 10:25:19 GMT+0800 (CST)
---
# 集成录制 SDK
...
5. 打开 TCP 目标端口：80、1080、5888、8000、9700、25000、30000。

6. 打开 UDP 目标端口：1080、4000-4030、7000、8000、8913、9700、25000。
7. 打开所有的录制进程所使用的单向下行端口。单向下行端口为在 `RecordingConfig` 中指定的 `lowUdpPort` 和 `highUdpPort` 范围之间的端口。
