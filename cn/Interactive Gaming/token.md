...
1. 进入 [Agora Dashboard](https://dashboard.agora.io/) ，并按照屏幕提示注册账号并登录 Dashboard。详见[创建新账号](../../cn/Interactive%20Gaming/sign_in_and_sign_up.md)。
2. 点击 **项目列表** 处的**新手指引**。
...
正式的 Token 需要在你的服务端部署并生成。详见[生成 Token](../../cn/Interactive%20Gaming/token_server.md)。
