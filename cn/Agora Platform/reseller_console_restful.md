...
updatedAt: Tue Oct 08 2019 06:45:36 GMT+0800 (CST)
---
# 代理商控制台 RESTful API
## 签名
...
| `amount`    | decimal | 金额。<br>**Note:**<br>若返回数据为 0，有以下两种可能：<ul><li>该项目未消耗用量。请使用用量接口查看该项目用量情况。<br><li>该项目消耗的用量未超过免费额度，不计费。                    |
