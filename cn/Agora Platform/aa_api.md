...
updatedAt: Sat Oct 12 2019 05:49:36 GMT+0800 (CST)
---
# 水晶球 RESTful API
水晶球现在提供 RESTful API，可以让你直接通过网络请求获取通话质量相关的数据，在自己的网页或应用中灵活使用。

在阅读本文之前，Agora 推荐你先在 [Dashboard](https://dashboard.agora.io) 中试用水晶球的通话调查功能，以便对各项参数和数据指标有更直观的了解，详情可参考[水晶球](../../cn/Agora%20Platform/aa_guide.md)。
...
水晶球 RESTful API 支持查询最近 3 天内的通话，此外在请求次数、数据延迟以及响应内容上还有以下限制：

| 接入点                       | 请求次数                | 数据延迟 | 响应内容                | 可查询通话范围 |
| ---------------------------- | ----------------------- | -------- | ----------------------- | -------------- |
