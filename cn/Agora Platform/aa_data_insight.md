...
![](https://web-cdn.agora.io/docs-files/1570772355750)
...
|     指标名称     | 指标说明                                                     |
| :--------------: | :----------------------------------------------------------- |
| 音频首次出声时间 | 从用户尝试加入频道到听到声音的时间，按每次通话排序取中位数（若加入频道时，频道内无音频流，则不纳入计算） |
| 视频首次出图时间 | 从用户尝试加入频道到看到画面的时间，按每次通话排序取中位数（若加入频道时，频道内无视频流，则不纳入计算） |

**用户体验**

|  指标名称  | 指标说明                                                     |
| :--------: | :----------------------------------------------------------- |
| 音频卡顿率 | 音频发生卡顿的时长 / 总音频时长。</br>2 秒内音频丢帧率达到 4% 即计为一次音频卡顿，音频卡顿时长 = 音频卡顿次数 × 2000 ms。 |
| 视频卡顿率 | 视频发生卡顿的时长 / 总视频时长。</br>视频卡顿为 600 ms 没有视频帧可渲染。 |

**网络延时**

|   指标名称   | 指标说明                                         |
| :----------: | :----------------------------------------------- |
| 音频网络延时 | 音频传输过程中，网络延时按每次通话排序的中位数。 |
| 视频网络延时 | 视频传输过程中，网络延时按每次通话排序的中位数。 |
