...
description: 
platform: Windows
updatedAt: Mon Sep 23 2019 07:21:27 GMT+0800 (CST)
---
# 原始音频数据
## 功能描述
...
## 实现方法
在使用原始数据功能前，请确保你已在项目中完成基本的实时音视频功能，详见[一对一通话](../../cn/Voice/start_call_windows.md)或[互动直播](../../cn/Voice/start_live_windows.md)。
...
![](https://web-cdn.agora.io/docs-files/1569211363140)
