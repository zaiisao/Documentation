...
description: 
platform: Android
updatedAt: Wed Feb 26 2020 03:14:06 GMT+0800 (CST)
---
# 实现语音通话
...
本节介绍如何创建项目，将 Agora 语音通话 SDK 集成进你的项目中，并添加相应的设备权限。
...
选择如下任意一种方式将 Agora 语音通话 SDK 集成到你的项目中。
...
dependencies {
    ...
    // 其中 2.9.4 是最新的 Agora 语音通话 SDK 的版本号。你也可以填写其他版本
...
1. 前往 [SDK 下载](https://docs.agora.io/cn/Agora%20Platform/downloads)页面，获取最新版的 Agora 语音通话 SDK，然后解压。
