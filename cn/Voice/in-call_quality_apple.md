...
<div class="alert note">请确保已在你的项目中实现基本的实时音视频功能。详见
  <li>iOS: <a href="../../cn/Voice/start_call_ios.md">开始音视频通话</a>或<a href="../../cn/Voice/start_live_ios.md">开始互动直播</a></li>
  <li>macOS: <a href="../../cn/Voice/start_call_mac.md">开始音视频通话</a>或<a href="../../cn/Voice/start_live_mac.md">开始互动直播</a.</li></div>
...
`remoteAudioStats` 回调向你报告当前通话中每个远端用户/主播音频流的统计信息。你可以了解到每个远端用户/主播发送的音频流质量（详见[质量打分](https://docs.agora.io/cn/Voice/API%20Reference/cpp/namespaceagora_1_1rtc.html#aeaf419fcafaa4d58da8b6d8718e31891)）、声道数（单声道或双声道）和以下重要参数信息。
...
- [`remoteVideoStateChangedOfUid`](https://docs.agora.io/cn/Voice/API%20Reference/oc/Protocols/AgoraRtcEngineDelegate.html#//api/name/rtcEngine:remoteVideoStateChangedOfUid:state:)
