...
description: 
platform: Android
updatedAt: Tue Sep 18 2018 21:31:28 GMT+0800 (CST)
---
# 设置开发环境
# 设置开发环境
...
-   Android [语音通话/语音直播 SDK](https://docs.agora.io/cn/2.3.1/download)
...
> 你也可以下载 [视频通话/视频直播 SDK](https://docs.agora.io/cn/2.3.1/download) 并设置开发环境。语音和视频包的唯一区别是视频 SDK 包含语音和视频功能，详见 [设置开发环境](../../cn/Quickstart%20Guide/android_video.md)。
...
2.  [下载](https://docs.agora.io/cn/2.3.1/download) Android 语音通话/语音直播 SDK。
...
现在你已经设置好了 Android 开发环境，可以开始使用 Agora 语音通话/语音直播 SDK 了！
