...
platform: Web
updatedAt: Thu Jul 18 2019 11:31:07 GMT+0800 (CST)
---
# 加入频道
## 前提条件
...
- `tokenOrKey`：能标识用户角色和权限的 Token。测试环境下，你可以使用获取到的临时 Token。生产环境下，我们推荐你使用在自己的服务端生成的正式 Token。关于如何生成正式 Token，详见[校验用户权限](../../cn/Voice/token.md)。
- `channel`：频道名称。
