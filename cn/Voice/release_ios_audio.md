...
该版本对数据统计相关回调进行了统一梳理，相关回调及算法详见[通话前检测网络质量](../../cn/Voice/lastmile_quality_apple.md)。
