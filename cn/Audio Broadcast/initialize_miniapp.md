...
platform: 微信小程序
updatedAt: Tue Oct 22 2019 04:08:18 GMT+0800 (CST)
---
# 初始化客户端对象
## 前提条件
...
1. 进入 [控制台](https://dashboard.agora.io/) ，并按照屏幕提示注册账号并登录控制台。详见[创建新账号](../../cn/Audio%20Broadcast/sign_in_and_sign_up.md)。
2. 点击**项目列表**处的**新手指引**。
