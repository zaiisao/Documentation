...
description: 
platform: Android
updatedAt: Tue Mar 10 2020 00:09:41 GMT+0800 (CST)
---
# 原始音频数据
## 功能描述
...
## 实现方法
在使用原始数据功能前，请确保你已在项目中完成基本的实时音视频功能，详见[一对一通话](../../cn/Audio%20Broadcast/start_call_android.md)或[互动直播](../../cn/Audio%20Broadcast/start_live_android.md)。
