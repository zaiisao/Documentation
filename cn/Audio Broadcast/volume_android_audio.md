...
platform: Android
updatedAt: Tue Aug 13 2019 07:17:26 GMT+0800 (CST)
---
# 调整通话音量
## 功能描述
...
### 设置混音音量
**混音**是指播放本地或者在线音乐文件，同时让频道内的其他人听到此音乐。你可以参考[音乐混音](../../cn/Audio%20Broadcast/effect_mixing_android_audio.md)开启混音功能。
...
#### API 参考
- [`adjustAudioMixingPublishingVolume`](https://docs.agora.io/cn/Audio%20Broadcast/API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a16c4dc66d9c43eef9bee7afc86762c00)
...
### 设置音效音量
播放**音效**是指播放短小的音频，如鼓掌、子弹撞击的声音等。你可以参考[播放音效](../../cn/Audio%20Broadcast/effect_mixing_android_audio.md)开启音效播放。
