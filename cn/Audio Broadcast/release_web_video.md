...
`StreamSpec` 类新增 [`optimizationMode`](https://docs.agora.io/cn/Audio%20Broadcast/API%20Reference/web/interfaces/agorartc.streamspec.html#optimizationmode) 属性。
...
在网络环境较差时，你可以通过设置 `bufferDelay` 参数提高延迟，以保证直播的流畅度。详见 [H5 实时直播](../../cn/Audio%20Broadcast/web_in_app.md)。
