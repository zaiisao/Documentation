...
description: 
platform: Ruby
updatedAt: Mon Nov 11 2019 09:38:58 GMT+0800 (CST)
---
# 在服务端生成 Token
...
| `privilege_expired_ts`      | 时间戳。自 1970 年 1 月 1 日零时起经过的秒数。比如你希望将权限设为 Token 生成后 10 分钟，那么你要在这里把 privilege_expired_ts 设为当前 timestamp 再加 600 (秒)。如果权限始终不过期，请填 0。 |
