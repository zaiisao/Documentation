...
## 开发注意事项
- iOS 日志文件的默认地址为 App Sandbox/Library/caches/agorasdk.log。
- 如需调用本方法，请在调用 [sharedEngineWithAppId](https://docs.agora.io/cn/Audio%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/sharedEngineWithAppId:delegate:) 方法初始化 AgoraRtcEngineKit 对象后立即调用，否则可能造成输出日志不完整。
