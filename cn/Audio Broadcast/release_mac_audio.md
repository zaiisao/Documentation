...
description: 
platform: macOS
updatedAt: Wed Jun 12 2019 09:38:19 GMT+0800 (CST)
---
# 发版说明
...
- [音频设备测试与切换](../../cn/Audio%20Broadcast/switch_audio_device_ios.md)

如果你是由之前版本的 Windows 完整包升级到当前版本，可参考 [macOS 完整包发版说明](../../cn/Audio%20Broadcast/release_mac_video.md)了解音频相关改进。
