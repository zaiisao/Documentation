...
description: 
platform: Windows
updatedAt: Wed Feb 27 2019 07:28:36 GMT+0000 (UTC)
---
# 推流到 CDN
## 功能描述
...
> -   主播需要在 <code>joinChannel</code> 后通过 <code>setLiveTranscoding</code> 接口定义转码参数和设置（RTMP 画布大小等信息）。CDN 音频推流时仍需设置一个 16 &times; 16 的最小视窗。
