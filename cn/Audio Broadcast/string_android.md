...
description: 
platform: Android
updatedAt: Wed Oct 16 2019 07:06:32 GMT+0800 (CST)
---
# 使用 String 型的用户名
## 场景描述
...
请确保你已了解实现基本的实时音视频功能的步骤及代码逻辑。详见[开始音视频通话](../../cn/Audio%20Broadcast/start_call_android.md)或[开始互动直播](../../cn/Audio%20Broadcast/start_live_android.md)。
