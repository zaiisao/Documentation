...
description: 
platform: Android
updatedAt: Thu Nov 05 2020 09:54:30 GMT+0800 (CST)
---
# 发送和接收点对点消息及频道消息
...
在项目的 **/app/build.gradle** 文件添加以下代码（1.4.1 为当前版本号）：
...
1. 下载最新版的 [Agora RTM Android SDK](https://docs.agora.io/cn/Real-time-Messaging/downloads) 并解压。
...
- 在收发点对点消息或进行其他频道操作前，请确保你已成功登录 Agora RTM 系统（即确保已经收到 [onSuccess](https://docs.agora.io/cn/Real-time-Messaging/API%20Reference/RTM_java/interfaceio_1_1agora_1_1rtm_1_1_result_callback.html#a7206b30500655c4a73d146acf50cb6f5)）。
