...
description: 
platform: Web
updatedAt: Thu Oct 31 2019 11:16:55 GMT+0800 (CST)
---
# 收发点对点消息和频道消息
...
2. 将下载下来的压缩包中路径为 `libs/agora-rtm-sdk-1.1.0.js` 的文件保存到你所操作的项目下。
3. 在项目相应的前端页面文件中，对刚才保存的 SDK 文件进行引用（其中 `/path/to/agora-rtm-sdk-1.1.0.js` 替换为可访问的 SDK 公开网址）：
