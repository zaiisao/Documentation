...
description: 
platform: Web
updatedAt: Wed Apr 03 2019 02:50:11 GMT+0000 (UTC)
---
# 发版说明
...
> - 如需在 iOS 12.2+ 或 macOS Mojave 10.14.4+ 上使用 Safari 浏览器， 必须升级至 Agora Web SDK 2.6。
...
- [`AgoraRTC.getSupportedCodec`](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/web/v2.6/globals.html?transId=2.6#getsupportedcodec)
...
- [`Client.on`](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/web/v2.6/interfaces/agorartc.client.html?transId=2.6#on) 新增以下事件：
  - `stream-fallback`
  - `stream-updated`

#### 修改

- [`Stream.startAudioMixing`](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/web/v2.6/interfaces/agorartc.stream.html?transId=2.6#startaudiomixing) 增加 `cacheResource` 参数
