...
platform: macOS
updatedAt: Fri Jul 19 2019 09:03:41 GMT+0800 (CST)
---
# 加入频道
...
-  传入能标识用户角色和权限的 Token。
	-   测试环境下，你可以使用临时 Token，详见[获取临时 Token](../../cn/Interactive%20Broadcast/token.md)。
	-   生产环境下，我们推荐你使用在自己的服务端生成的正式 Token。关于如何生成正式 Token，详见[服务端生成 Token](../../cn/Interactive%20Broadcast/token_server.md)。
