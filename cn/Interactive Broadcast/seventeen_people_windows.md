...
description: 7+
platform: Windows
updatedAt: Mon Jun 10 2019 07:40:59 GMT+0800 (CST)
---
# 实现七人以上视频通话
...
- 信令系统告知频道内哪个学生上了讲台。老师和学生可以调用 `setRemoteVideoStreamType` 订阅想要看到的学生的大流。PC 端最多支持 1 个大流 16 个小流；移动端最多支持 1 个大流 6 个小流。
## 1. 用户角色
