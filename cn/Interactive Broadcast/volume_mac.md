...
platform: macOS
updatedAt: Mon Jan 13 2020 08:09:26 GMT+0800 (CST)
---
# 调整通话音量
## 功能描述
...
**采集**是指音频信号由录音设备采集后传输到发送端的过程。你可以通过调整**录音设备音量**或**录音信号音量**来设置采集音量。在 macOS 系统上，Agora 推荐使用音频设备相关 API 调节录音音量。
...
混音是指播放本地或者在线音乐文件，同时让频道内的其他人听到此音乐。你可以参考[播放音效/混音](../../cn/Interactive%20Broadcast/effect_mixing_mac.md)开启混音功能。
...
播放音效是指播放短小的音频，如鼓掌、子弹撞击的声音等。你可以参考[播放音效/混音](../../cn/Interactive%20Broadcast/effect_mixing_mac.md)开启音效播放。
