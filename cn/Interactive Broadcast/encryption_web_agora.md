...
description: 
platform: Web
updatedAt: Fri Jan 04 2019 10:11:47 GMT+0800 (CST)
---
# 选择加密方案
...
请确保在调用 [`join`](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/web/interfaces/agorartc.client.html#join) 加入 Agora RTC 频道之前调用该方法。
