...
description: 
platform: Web
updatedAt: Thu Jan 24 2019 06:19:31 GMT+0000 (UTC)
---
# 进行屏幕共享
## 功能简介
...
在 Chrome 上使用屏幕共享功能需要安装 Agora 提供的 [Chrome 屏幕共享插件](../../cn/Interactive%20Broadcast/chrome_screensharing_plugin.md) ，在建流的时候把插件的 **extensionId** 填进字段。
