...
description: 
platform: iOS,macOS
updatedAt: Fri Sep 20 2019 07:31:32 GMT+0800 (CST)
---
# 使用 String 型的用户名
## 场景描述
...
- iOS 平台：[开始音视频通话](../../cn/Interactive%20Broadcast/start_call_ios.md)或[开始互动直播](../../cn/Interactive%20Broadcast/start_live_ios.md)
- macOS 平台：[开始音视频通话](../../cn/Interactive%20Broadcast/start_call_mac.md)或[开始互动直播](../../cn/Interactive%20Broadcast/start_live_mac.md)
...
同时，我们在 Github 提供一个开源的 [String-Account](https://github.com/AgoraIO/Advanced-Video/tree/master/String-Account) 示例项目。你可以前往下载，或参考 [VideoChatViewController.swift](https://github.com/AgoraIO/Advanced-Video/blob/master/String-Account/Agora-String-Account-iOS-Swift/Agora%20iOS%20Tutorial/VideoChat/VideoChatViewController.swift) 文件中 `joinChannel` 方法的源代码。
