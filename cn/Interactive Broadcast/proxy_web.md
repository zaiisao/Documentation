...
description: 
platform: Web
updatedAt: Fri Sep 28 2018 18:01:15 GMT+0800 (CST)
---
# 企业部署代理服务器
# 企业部署代理服务器
...
企业用户需要先自行部署 Nginx 和 TURN 服务器，然后再调用 Agora Web SDK 的接口前，来实现 Proxy 功能。关于如何部署，请参考以下步骤：
...
1. 访问网址 [https://github.com/AgoraIO/proxy-for-webrtc](https://github.com/AgoraIO/proxy-for-webrtc) 并下载 turnServer 安装包。完整的安装包内含四个文件：`README`，`turnserver`, `turnserver.conf` 和 `turnserver.sh` 。
