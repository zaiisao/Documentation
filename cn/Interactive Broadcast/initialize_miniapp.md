...
1. 进入[控制台](https://console.agora.io/)，并按照屏幕提示注册账号并登录控制台。详见[创建新账号](../../cn/Interactive%20Broadcast/sign_in_and_sign_up.md)。
...
> - 如果你的 App ID 启用了 App 证书，则在 [加入频道](../../cn/Interactive%20Broadcast/join_live_mini.md) 时必须使用 Channel Key 或 Token。
