...
审核结果将直接通知到你通过 `callbackAddr` 参数设置的地址。详情见[审核结果的回调](../../cn/Interactive%20Broadcast/restful_api_ali_audio.md)。
...
如果你在集成和使用中遇到其他问题，可以参考[常见错误](../../cn/Interactive%20Broadcast/restful_api_ali_audio.md)。
