...
updatedAt: Fri Sep 28 2018 20:01:19 GMT+0800 (CST)
---
# 实现 17 人直播场景
# 实现 17 人直播场景

在一般的视频直播场景中，如果连麦人数过多，可能会引起音画不同步、信息丢失等问题。 如果参与连麦的各方将订阅流设置为 **1-N** 模式，即将 1 方设为大流，其余各方设为小流，那么最多可以支持 17 人互动直播，并支持实时转码推流。

本文展示 17 人直播的适用场景及相关接口，以及使用该功能的相关注意事项。

## 场景描述

以在线直播课为例，17 人直播支持实现如下功能：
...
17 人视频项目设置每个客户端为主播，视频的实质是主播之间的互相连麦。因为没有观众的角色也就没有观众连麦上麦。

## 2. 进入频道前的参数设置

在 `joinChannel` 前需要进行如下设置:

- 开启多人视频通信模式：`setParameters\(“\{“che.audio.live\_for\_comm”:true\}”\);`
