...
description: 
platform: macOS
updatedAt: Tue Oct 22 2019 06:02:56 GMT+0800 (CST)
---
# 发版说明
...
为保证通信质量，频道内所有用户需使用同一数据类型的用户名，即频道内的所有用户名应同为 Int 型或同为 String 型。详见[使用 String 型的用户名](../../cn/Interactive%20Broadcast/string_mac.md)。
