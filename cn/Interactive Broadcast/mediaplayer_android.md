...
description: 
platform: Android
updatedAt: Mon Mar 02 2020 04:27:30 GMT+0800 (CST)
---
# 媒体播放器组件
## 功能描述
...
3. （可选）调用RtcEngine 接口的 `setVideoSource( new AgoraDefaultSource() )` 将播放器画面切换回主播的画面，使远端用户重新看到主播。
...
详见 [API 文档](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/mediaplayer_java/1.1.0/index.html)
