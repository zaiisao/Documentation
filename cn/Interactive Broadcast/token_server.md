...
<td>Agora 为应用程序开发者签发的 App Certificate。当启用 App Certificate 后，原有的 App ID 会失效，详见 <a href="../../cn/Interactive%20Broadcast/token.md"><span>获取 App Certificate</span></a>。</td>
</tr>
