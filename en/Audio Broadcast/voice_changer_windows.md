...
Before proceeding, ensure that you implement a basic call or the interactive live streaming in your project. See [Start a call](../../en/Audio%20Broadcast/start_call_windows.md) or [Start the interactive live streaming](../../en/Audio%20Broadcast/start_live_windows.md) for details.
