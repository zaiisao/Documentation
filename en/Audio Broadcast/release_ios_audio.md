...
description: 
platform: iOS
updatedAt: Mon Sep 14 2020 03:33:09 GMT+0800 (CST)
---
# Release Notes
...
- [`enableSoundPositionIndication`](https://docs.agora.io/en/Audio%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/enableSoundPositionIndication:)
...
- [`setLogFileSize`](https://docs.agora.io/en/Audio%20Broadcast/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/setLogFileSize:)
...
For the list of API methods related to the call quality statistics and on how and when to use them, see [Report In-call Statistics](../../en/Audio%20Broadcast/in-call_quality_apple.md).
