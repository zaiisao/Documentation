...
description: 
platform: macOS
updatedAt: Thu Dec 13 2018 22:33:52 GMT+0000 (UTC)
---
# Join a Channel
...
- Pass a token that identifies the role and privilege of the user. Set the token as null for low-security requirements. A token is generated at the server of the application. For how to generate a token, see [Security Keys](../../en/Audio%20Broadcast/token.md).
