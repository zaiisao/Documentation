...
Suppose a user is in a channel for 30 minutes, then Agora logs 30 audio minutes for that user regardless whether the user is idle or has subscribed to other users.
