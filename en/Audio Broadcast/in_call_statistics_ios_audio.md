...
description: 
platform: iOS
updatedAt: Mon Feb 18 2019 08:52:29 GMT+0000 (UTC)
---
...
The `networkQuality` callback uses the `uid` parameter. If a channel has multiple users, the SDK triggers the callback as many times. The ratings include: 
...
- The `networkQuality` callback reports the uplink and downlink last-mile quality between the device of each user in a channel.
