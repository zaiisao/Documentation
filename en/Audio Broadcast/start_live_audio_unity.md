...
description: 
platform: Unity
updatedAt: Fri Dec 13 2019 07:40:21 GMT+0800 (CST)
---
...
Choose either of the following approaches to integrate the Agora RTC SDK for Unity into your project.
...
4. When the download completes, the button becomes **Import**. Click **Import** to show the packages of the downloaded SDK.
...
![](https://web-cdn.agora.io/docs-files/1576222487818)
