...
platform: Windows
updatedAt: Mon Jan 13 2020 08:33:49 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Effects/Mixing](../../en/Audio%20Broadcast/audio_effect_mixing_windows.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects/Mixing](../../en/Audio%20Broadcast/audio_effect_mixing_windows.md) for enabling this function.
