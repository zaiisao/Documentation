...
platform: Windows
updatedAt: Fri Sep 20 2019 03:46:01 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Mixing](../../en/Audio%20Broadcast/effect_mixing_windows.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Audio%20Broadcast/effect_mixing_windows.md) for enabling this function.
