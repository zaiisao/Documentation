...
description: 
platform: Web
updatedAt: Wed Jul 24 2019 07:18:29 GMT+0800 (CST)
---
# Integrate the SDK
...
3. Understand the limitations in [Known Issues](../../en/Audio%20Broadcast/release_web_video.md) and [FAQ](https://docs.agora.io/en/search?type=faq&platform=Web).
...
2. Copy the `AgoraRTCSDK-2.8.0.js` file to your project.

3. Reference the `AgoraRTCSDK-2.8.0.js` file in your project.
...
- [Initialize the SDK](../../en/Audio%20Broadcast/initialize_web_live.md)
- [Join a Channel](../../en/Audio%20Broadcast/join_live_web.md)
- [Publish and Subscribe to Streams](../../en/Audio%20Broadcast/publish_web_live.md)
