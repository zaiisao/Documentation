...
- [Generate a Token](../../en/Audio%20Broadcast/token_server_cpp.md)
...
- Added the [`addInjectStreamUrl`](https://docs.agora.io/en/Audio%20Broadcast/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a42247db589b55d3cfa98d8e1be06d8e6) API to enble adding a voice or video stream HTTP/HTTPS URL address to the live interactive streaming.
