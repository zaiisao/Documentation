...
Before enabling the encryption, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](../../en/Audio%20Broadcast/start_call_windows.md) or [Start Live Interactive Video Streaming](../../en/Audio%20Broadcast/start_live_windows.md).
