...
platform: Server
updatedAt: Mon Jul 22 2019 04:13:55 GMT+0800 (CST)
---
...
You can create your own token generator using the public methods that **SimpleTokenBuilder.h** provides. Note that **SimpleTokenBuilder.h** supports both int uid and string userAccount. Ensure that you chose the right method. 
