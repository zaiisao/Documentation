...
If you migrate to this SDK from the Windows Video SDK, refer to the [Release notes for Windows video SDK](../../en/Audio%20Broadcast/release_windows_video.md) for audio improvements.
