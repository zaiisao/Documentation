...
See [Setting up Your Development Environment](../../en/Quickstart%20Guide/web_prepare.md) for the the prerequisites, environment setup, and SDK integration guide.

## Using Core APIs to Start a Live Voice Broadcast

The following lists the major steps to start a live voice broadcast on the Web：
...
The `index.html` file in the sample app contains the complete code of the following APIs for the reference. Use these APIs in a web app to start a live voice broadcast.

### <a name = "createClient"></a>Create a Client

Use the `AgoraRTC.createClient` method to create a client object. 
...
Now you can run the app, enter a channel name, and start a live voice broadcast.

> Ensure your camera and microphone work before starting a live voice broadcast.
...
Refer to the following links to add more functions to a live voice broadcast:
...
Find all the Agora APIs that can be implemented in a live voice broadcast in [Agora Web SDK API](https://docs.agora.io/en/Interactive%20Broadcast/API%20Reference/web/index.html).
