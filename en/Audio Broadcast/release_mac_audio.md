...
- [Test or select a media device](../../en/Audio%20Broadcast/switch_audio_device_ios.md)

If you migrate to this Voice SDK from the Windows Video SDK, refer to the [Release notes for Windows video SDK](../../en/Audio%20Broadcast/release_mac_video.md) for audio improvements.
