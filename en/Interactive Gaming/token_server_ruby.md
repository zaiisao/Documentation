...
description: 
platform: Ruby
updatedAt: Sun Aug 11 2019 15:34:06 GMT+0800 (CST)
---
...
| `privilege_expired_ts`      | Time represented by the number of seconds elapsed since 1/1/1970. If, for example, you want to access the Agora Service within 10 minutes after the token is generated, set privilege_expired_ts as the current timestamp + 600 (seconds). |
