...
Before proceeding, ensure that you implement a basic call or live interactive streaming in your project. See [Start a Video Call](../../en/Voice/start_call_unity.md) or [Start Live Interactive Video Streaming](../../en/Voice/start_live_unity.md) for details.
