...
description: 
platform: macOS
updatedAt: Fri Apr 26 2019 08:20:27 GMT+0800 (CST)
---
...
Ensure that you prepared the development environment. See [Integrate the SDK](../../en/Voice/mac_video.md).
...
* [`pushExternalAudioFrameRawData:samples:timestamp:`](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraRtcEngineKit.html#//api/name/pushExternalAudioFrameRawData:samples:timestamp:)
