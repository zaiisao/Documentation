...
updatedAt: Wed Oct 30 2019 03:26:02 GMT+0800 (CST)
---
# Console RESTful API
## 1. Authentication

> Before using the RESTful APIs, ensure that your account has enabled the relevant privilege of a specified project in Agora Console. Agora supports customizing different user roles and privileges. For more information, see [Management members](../../en/Voice/dashboard.md).
