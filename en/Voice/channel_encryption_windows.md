...
Before enabling the encryption, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](../../en/Voice/start_call_windows.md) or [Start Live Interactive Video Streaming](../../en/Voice/start_live_windows.md).
