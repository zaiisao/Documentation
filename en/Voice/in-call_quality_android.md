...
<div class="alert note">Ensure that you implement a video call or an interactive broadcast in your project. For details, see <a href="../../en/Voice/start_call_android.md">Start a Call</a> or <a href="../../en/Voice/start_live_android.md">Start an Interactive Broadcast</a>.</div>
