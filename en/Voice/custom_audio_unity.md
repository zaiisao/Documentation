...
Before customizing the audio source or sink, ensure that you implement the basic real-time communication functions in your project. For details, see [Start a Voice Call](../../en/Voice/start_call_audio_unity.md) or [Start an Audio Broadcast](../../en/Voice/start_live_audio_unity.md).
...
- [`SetExternalAudioSink`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a91a7599be9ca163f0b43c83a4b3a902e)
