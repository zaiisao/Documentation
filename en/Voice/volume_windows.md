...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Effects/Mixing](../../en/Voice/effect_mixing_windows.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects/Mixing](../../en/Voice/effect_mixing_windows.md) for enabling this function.
