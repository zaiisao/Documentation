...
v3.2.0 adds the [`optimizationMode`](https://docs.agora.io/en/Voice/API%20Reference/web/interfaces/agorartc.streamspec.html#optimizationmode) property in `StreamSpec`.
...
Added the event `"stream-unpublished"` in [`Client.on`](https://docs.agora.io/en/Voice/API%20Reference/web/interfaces/agorartc.client.html#on).
...
- [`Client.startProxyServer`](https://docs.agora.io/en/Voice/API%20Reference/web/interfaces/agorartc.client.html#startproxyserver)
- [`Client.stopProxyServer`](https://docs.agora.io/en/Voice/API%20Reference/web/interfaces/agorartc.client.html#stopproxyserver)
