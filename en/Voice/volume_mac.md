...
platform: macOS
updatedAt: Mon Jun 10 2019 01:50:05 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
## Implementation
Before proceeding, ensure that you prepare the development environment. See [Integrate the SDK](../../en/Voice/mac_video.md).
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Mixing](../../en/Voice/effect_mixing_mac.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Voice/effect_mixing_mac.md) for enabling this function.
