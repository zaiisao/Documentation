...
Before setting the audio profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](../../en/Voice/start_call_audio_unity.md) or [Start Live Interactive Streaming](../../en/Voice/start_live_audio_unity.md).
...
Call this method before calling the [`JoinChannelByKey`](https://docs.agora.io/en/Voice/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a5997a90398afe355d4d509a2a83a9999) method.
