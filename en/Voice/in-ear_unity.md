...
Before using the in-ear monitoring function, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](../../en/Voice/start_call_audio_unity.md) or [Start a Voice Broadcast](../../en/Voice/start_live_audio_unity.md) for details.
