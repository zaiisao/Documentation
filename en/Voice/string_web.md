...
Ensure that you understand the steps and code logic for implmenting the basic real-time communication functions. For details, see [Start a Call](../../en/Voice/start_call_web.md) or [Start a live broadcast](../../en/Voice/start_live_web.md).
