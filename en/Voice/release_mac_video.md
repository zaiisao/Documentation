...
- The  [captureMouseCursor](https://docs.agora.io/en/Voice/API%20Reference/oc/Classes/AgoraScreenCaptureParameters.html#//api/name/captureMouseCursor) parameter in the `AgoraScreenCaptureParameters` class
