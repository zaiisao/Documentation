...
- Errors might occur when you call the stream.init method, see the [API Reference](https://docs.agora.io/en/Voice/API%20Reference/web/interfaces/agorartc.stream.html#init) for details.
