...
Before proceeding, ensure that you implement a basic call or live interactive streaming in your project. See [Start a Video Call](../../en/Voice/start_call_windows.md) or [Start Live Interactive Video Streaming](../../en/Voice/start_live_windows.md) for details.
...
* [`stopAudioRecording`](https://docs.agora.io/en/Voice/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#adb392026425663e5b9f90fe90130e5a5)
