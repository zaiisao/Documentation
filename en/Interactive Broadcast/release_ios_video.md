...
description: 
platform: iOS
updatedAt: Mon Oct 26 2020 10:36:10 GMT+0800 (CST)
---
# Release Notes
...
Adds RESTful APIs to check the status of the users in the channel, the channel list of a specific company, and whether the user is an audience or a host. For detailed information, see [RESTful API](../../en/Interactive%20Broadcast/dashboard_restful_communication.md).

##### 4. 17-way video

Adds the support of 17-way video in interactive streaming, see:

-   [Start Live interactive streaming](../../en/Interactive%20Broadcast/start_live_ios.md)
...
Adds the function of injecting an external video stream to an ongoing live interactive streaming, see [Injecting an External Stream to Live Interactive Streaming](../../en/Interactive%20Broadcast/inject_stream_apple.md).
