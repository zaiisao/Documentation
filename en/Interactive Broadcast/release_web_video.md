...
description: 
platform: Web
updatedAt: Tue Nov 06 2018 08:21:22 GMT+0000 (UTC)
---
# Release Notes
...
> If you have set the domain firewall, ensure `*.agoraio.cn` and `*.agora.io` are added to your white list before using this version.
