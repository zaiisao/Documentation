...
platform: Android
updatedAt: Thu Dec 27 2018 02:42:29 GMT+0000 (UTC)
---
# Adjust the Volume
## Introduction
...
- [`adjustAudioMixingPublishingVolume`](../../en/Interactive%20Broadcast/volume_android.md)
- [`adjustAudioMixingPlayoutVolume`](../../en/Interactive%20Broadcast/volume_android.md)
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](https://docs.agora.io/en/Video/effect_mixing_android?platform=Android#play-audio-effect-files) for enabling this function.
