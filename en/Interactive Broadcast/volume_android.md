...
platform: Android
updatedAt: Wed Sep 25 2019 10:07:01 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Effects/Mixing](../../en/Interactive%20Broadcast/effect_mixing_android.md) for enabling this function.
...
**Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects/Mixing](../../en/Interactive%20Broadcast/effect_mixing_android.md) for enabling this function.
