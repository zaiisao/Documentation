...
description: 
platform: Web
updatedAt: Mon Sep 07 2020 12:16:32 GMT+0800 (CST)
---
...
2. Copy the `AgoraRTCSDK-3.2.0.js` file to the same directory as your project file.

3. Add the following code to the line above `</body>` in your project.

   ```javascript
   <script src="./AgoraRTCSDK-3.2.0.js"></script>
   ```

For simplicity, let's include the Agora Web SDK from a CDN source and copy `<script src="https://cdn.agora.io/sdk/release/AgoraRTCSDK-3.2.0.js"></script>` to the project file.
