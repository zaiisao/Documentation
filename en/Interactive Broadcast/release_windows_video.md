...
description: 
platform: Windows
updatedAt: Wed Jan 16 2019 15:29:51 GMT+0000 (UTC)
---
# Release Notes
...
The version 2.3.2 was released on Jan. 19th, 2019. See below for new features, improvements, and issues fixed.
...
-   Web: Added and updated a series of APIs to enable interoperability between the web browsers and native clients for communication or live broadcast scenarios. For details, refer to [Release Notes](../../en/Interactive%20Broadcast/release_web_video.md).
