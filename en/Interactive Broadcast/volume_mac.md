...
platform: macOS
updatedAt: Thu Dec 27 2018 02:59:06 GMT+0000 (UTC)
---
# Adjust the Volume
## Introduction
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Mixing](../../en/Interactive%20Broadcast/effect_mixing_mac.md) for enabling this function.
...
- [`adjustAudioMixingPublishingVolume`](../../en/Interactive%20Broadcast/volume_mac.md)
- [`adjustAudioMixingPlayoutVolume`](../../en/Interactive%20Broadcast/volume_mac.md)
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Interactive%20Broadcast/effect_mixing_mac.md) for enabling this function.
...
```objective-c
// objective-c
// Gets the ID of the loudest speaker at an instant.
// speakers is an array that contains uid and volumne of the speaker, volume ranging between 0 and 255.
// totalVolume is the toal volume after audio mixing, ranging between 0 to 255.
