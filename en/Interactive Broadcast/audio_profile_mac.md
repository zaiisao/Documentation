...
platform: macOS
updatedAt: Wed Sep 25 2019 10:08:33 GMT+0800 (CST)
---
...
Before setting the audio profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](../../en/Interactive%20Broadcast/start_call_mac.md) or [Start a Live Broadcast](../../en/Interactive%20Broadcast/start_live_mac.md).
...
![](https://web-cdn.agora.io/docs-files/1568974061814)
