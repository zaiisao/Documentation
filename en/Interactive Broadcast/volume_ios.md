...
platform: iOS
updatedAt: Fri Jan 03 2020 03:30:37 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
## Implementation
Before adjusting the audio volume, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](../../en/Interactive%20Broadcast/start_call_ios.md) or [Start a Live Broadcast](../../en/Interactive%20Broadcast/start_live_ios.md).
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Effects/Mixing](../../en/Interactive%20Broadcast/effect_mixing_ios.md) for enabling this function.
...
**Audio effects** are short sounds such as clapping and gunshots. See [Audio Effects/Mixing](../../en/Interactive%20Broadcast/effect_mixing_ios.md) for enabling this function.
