...
platform: iOS
updatedAt: Wed Dec 26 2018 10:08:41 GMT+0000 (UTC)
---
# Adjust the Volume
## Introduction
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Mixing](../../en/Interactive%20Broadcast/effect_mixing_ios.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Interactive%20Broadcast/effect_mixing_ios.md) for enabling this function.
