...
description: 
platform: iOS,macOS
updatedAt: Wed Dec 12 2018 07:10:13 GMT+0000 (UTC)
---
...
Whether or not to enable dual-stream mode depends on the application scenario. If your app uses dual windows (one big and one small), then Agora recommends enabling dual-stream mode. Call `enableDualStreamMode` to enable dual-stream mode:
