...
Ensure that you understand the steps and code logic for implmenting the basic real-time communication functions. For details, see [Start a Call](../../en/Interactive%20Broadcast/start_call_win.md) or [Start a Live Broadcast](../../en/Interactive%20Broadcast/start_live_win.md).
