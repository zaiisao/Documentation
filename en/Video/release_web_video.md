...
- [`Client.sendMetadata`](https://docs.agora.io/en/Video/API%20Reference/web/interfaces/agorartc.client.html#sendmetadata)
- New events in [`Client.on`](https://docs.agora.io/en/Video/API%20Reference/web/interfaces/agorartc.client.html#on):
  - `"receive-metadata"`
  - `"stream-unpublished"`
