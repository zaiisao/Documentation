...
description: 
platform: Web
updatedAt: Tue Jun 11 2019 06:16:52 GMT+0800 (CST)
---
# Release Notes
...
- [`AgoraRTC.getSupportedCodec`](https://docs.agora.io/en/Video/API%20Reference/web/v2.6/globals.html?transId=2.6#getsupportedcodec)
...
- New callbacks added in the [`Client.on`](https://docs.agora.io/en/Video/API%20Reference/web/v2.6/interfaces/agorartc.client.html?transId=2.6#on) method: 
  - `stream-fallback`
  - `stream-updated`

#### API updates

- Adds the `cacheResource` parameter in the [`Stream.startAudioMixing`](https://docs.agora.io/en/Video/API%20Reference/web/v2.6/interfaces/agorartc.stream.html?transId=2.6#startaudiomixing) method.
...
- New callbacks added in the [`Client.on`](https://docs.agora.io/en/Video/API%20Reference/web/interfaces/agorartc.client.html#on) method:
  ...
  - `exception`
- New callbacks added in the [`Stream.on`](https://docs.agora.io/en/Video/API%20Reference/web/interfaces/agorartc.stream.html?transId=883bbba0-1968-11e9-aeca-4be8cfc1d3d0#on) method:
  - `audioMixingPlayed`
  - `audioMixingFinished`
