...
platform: Windows
updatedAt: Mon Jul 06 2020 09:21:38 GMT+0800 (CST)
---
# Adjust the Volume
## Introduction
...
## Implementation
Before adjusting the audio volume, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](../../en/Video/start_call_windows.md) or [Start Live Interactive Streaming](../../en/Video/start_live_windows.md).
...
- [`adjustUserPlaybackSignalVolume`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a609e74c9a6e8df205543326f2ca6a965)
...
**Audio mixing** is the process of combining local or online music files with the local stream so that all the remote users in the channel can hear the host and the music at the same time. See [Audio Effects/Mixing](../../en/Video/audio_effect_mixing_windows.md) for more information about enabling this function.
...
### Adjust the audio effects volume
 ...
 An **audio effects** here refers to a sound clip which plays a brief sound effect such as clapping or gunshots. See [Audio Effects/Mixing](../../en/Video/audio_effect_mixing_windows.md) for more information on how to enable this function.
