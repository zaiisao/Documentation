...
Before proceeding, ensure that you implement a basic video call or live broadcast in your project. See [Start a Call](../../en/Video/start_call_windows.md)/[Start a Live Broadcast](../../en/Video/start_live_windows.md) for details.
