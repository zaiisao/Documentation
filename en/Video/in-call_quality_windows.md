...
<div class="alert note">Ensure that you implement a video call or an interactive broadcast in your project. For details, see <a href="../../en/Video/start_call_windows.md">Start a Call</a> or <a href="../../en/Video/start_live_windows.md">Start an Interactive Broadcast</a>.</div>
