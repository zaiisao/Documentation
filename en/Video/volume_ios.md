...
- [`adjustAudioMixingPublishingVolume`](../../en/Video/volume_ios.md)
- [`adjustAudioMixingPlayoutVolume`](../../en/Video/volume_ios.md)
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Video/effect_mixing_ios.md) for enabling this function.
