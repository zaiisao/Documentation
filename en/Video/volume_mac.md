...
### Adjust the audio effects volume
 ...
 An **audio effects** here refers to a sound clip which plays a brief sound effect such as clapping or gunshots. See [Audio Effects/Mixing](../../en/Video/audio_effect_mixing_apple.md) for more information on how to enable this function.
