...
platform: macOS
updatedAt: Tue Jan 29 2019 02:33:13 GMT+0000 (UTC)
---
# Adjust the Volume
## Introduction
...
## Implementation
Before proceeding, ensure that you prepare the development environment. See [Integrate the SDK](../../en/Video/mac_video.md).
...
**Audio mixing** is playing local or online music while speaking, so that other users in the channel can hear the speaker and the music simultaneously. See [Audio Mixing](../../en/Video/effect_mixing_mac.md) for enabling this function.
 ...
 **Audio effects** are certain short-time sounds such as clapping and gunshots. See [Audio Effects](../../en/Video/effect_mixing_mac.md) for enabling this function.
