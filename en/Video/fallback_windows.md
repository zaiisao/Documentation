...
Before proceeding, ensure that you implement live interactive video streaming in your project. See [Start Live Interactive Video Streaming](../../en/Video/start_live_windows.md) or [Start a Call](../../en/Video/start_call_windows.md) for details.
