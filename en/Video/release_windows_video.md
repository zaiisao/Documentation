...
description: 
platform: Windows
updatedAt: Fri Oct 18 2019 04:06:26 GMT+0800 (CST)
---
# Release Notes
...
To ensure smooth communication, use the same parameter type to identify all users within a channel, that is, all users should use either the integer user ID or the string user account to join a channel. For details, see [Use String User Accounts](../../en/Video/string_windows.md).
