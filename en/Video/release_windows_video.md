...
If you using an Agora SDK version v2.0.x and wish to migrate the v2.3.2, refer to the [Migration Guide](../../en/Video/migration_windows.md) for major API changes.
