...
description: 
platform: Windows
updatedAt: Thu Nov 12 2020 08:32:33 GMT+0800 (CST)
---
# Release Notes
...
If you have specified a region for connection when calling [`initialize`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#ac71db65e66942e4e0a0550e95c16890f), ensure that you use the latest area code when migrating from an earlier SDK version.
...
- [`onAudioPublishStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af5188bdc817fa62aac51b3dc627dfb64)
- [`onVideoPublishStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a72e100956b925151a217b99ab66c0425)
- [`onAudioSubscribeStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae3f517bd166a9e34aa77f9fbf137a7b9)
- [`onVideoSubscribeStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aebedc2b484b4e6b9f5d9a28aea997d65)
- [`onFirstLocalAudioFramePublished`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a03058e62a0a4a41e80ecf0279975ab99)
- [`onFirstLocalVideoFramePublished`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a55b8755b6b0d672b23013ed438b4eca2)
...
- `txPacketLossRate` in the [`LocalAudioStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_local_audio_stats.html) struct
- `txPacketLossRate` and `captureFrameRate` in the [`LocalVideoStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_local_video_stats.html) struct
- `publishDuration` in the [`RemoteAudioStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_remote_audio_stats.html) and [`RemoteVideoStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_remote_video_stats.html) structs
- `windowFocus` and `excludeWindowList` in the [`ScreenCaptureParameters`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_screen_capture_parameters.html) struct
- `LOCAL_VIDEO_STREAM_STATE_CAPTURING(1)` in the [`LOCAL_VIDEO_STREAM_STATE`](https://docs.agora.io/en/Video/API%20Reference/cpp/namespaceagora_1_1rtc.html) enum
- `LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_WINDOW_MINIMIZED(11)` in the [`LOCAL_VIDEO_STREAM_ERROR`](https://docs.agora.io/en/Video/API%20Reference/cpp/namespaceagora_1_1rtc.html) enum
- [`setVideoSource`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html)
- [`IVideoSource`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_video_source.html) class
- [`IVideoFrameConsumer`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_video_frame_consumer.html) class
- [`onRtmpStreamingEvent`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#aa2beb17562a3be9b5ddbe9366245cb0e)
...
`areaCode` member in the [`RtcEngineContext`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_rtc_engine_context.html) struct
...
Adds `setBeautyEffectOptions` for enabling image enhancement in scenarios such as video social networking, an online class, or live interactive streaming. You can call this method to set parameters including contrast, brightness, smoothness, red saturation, and so on. See [Image Enhancement](../../en/Video/image_enhancement_windows.md) for details.
...
This release supports RGBA raw video data. Use the [`getVideoFormatPreference`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1media_1_1_i_video_frame_observer.html#a440e2a33140c25dfd047d1b8f7239369) method to set the format of the raw video data format.
...
This release adds a new [`addVideoWatermark`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a36e51346ec3bd5a7370d7c70d58d9394) method with the following settings:
...
- [`addVideoWatermark`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a36e51346ec3bd5a7370d7c70d58d9394)
...
- The `report_vad` parameter in the [`enableAudioVolumeIndication`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a4b30a8ff1ae50c4c114ae4f909c4ebcb) method
- The `vad` member in the [`AudioVolumeInfo`](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_audio_volume_info.html) class
...
- [`setLiveTranscoding`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a0601e4671357dc1ec942cccc5a6a1dde)
- [`addPublishStreamUrl`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#a5d62a13bd8391af83fb4ce123450f839)
...
For how to implement the new methods, see [Push Streams to the CDN](../../en/Video/cdn_streaming_windows.md).
...
- [`onUserEnableVideo`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a91bef59a3659b6e6bcbe43eb203d0732)
- [`onUserEnableLocalVideo`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a23189a2a10fb8b06b774543ac6bb322b)
- [`onFirstRemoteVideoDecoded`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a345a8441861b9dbdc7ffc36a6c6ba186)
...
For more information on the implementation, API call sequence, sample code, and considerations, see [Co-host across Channels](../../en/Video/media_relay_windows.md).
...
- `onMicrophoneEnabled`. Use LOCAL_AUDIO_STREAM_STATE_CHANGED(0) or LOCAL_AUDIO_STREAM_STATE_RECORDING(1) in the [`onLocalAudioStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a9296c329331eb83b3af1315c52e7f91a) callback instead.
- `onRemoteAudioTransportStats`. Use the [`onRemoteAudioStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af8a59626a9265264fb4638e048091d3a) callback instead.
- `onRemoteVideoTransportStats`. Use the [`onRemoteVideoStats`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a7163ffb650852be270ba0215b596d968) callback instead.
- `onUserEnableVideo`. Use the [`onRemoteVideoStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae69799238c6a6cd9f017274dd630b74e) callback with the following parameters instead:
...
- `onUserEnableLocalVideo`. Use the [`onRemoteVideoStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae69799238c6a6cd9f017274dd630b74e) callback with the following parameters instead:
	- REMOTE_VIDEO_STATE_STOPPED(0) and REMOTE_VIDEO_STATE_REASON_REMOTE_MUTED(5).
	- REMOTE_VIDEO_STATE_DECODING(2) and REMOTE_VIDEO_STATE_REASON_REMOTE_UNMUTED(6).

- `onFirstRemoteVideoDecoded`. Use REMOTE_VIDEO_STATE_STARTING(1) or REMOTE_VIDEO_STATE_DECODING(2) in the [`onRemoteVideoStateChanged`](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#ae69799238c6a6cd9f017274dd630b74e) callback instead.
...
This release also adds the `numChannels`, `receivedSampleRate`, and `receivedBitrate` members in the [RemoteAudioStats](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_remote_audio_stats.html) class.
...
- The `numChannels`, `receivedSampleRate`, `receivedBitrate`, `totalFrozenTime`, and `frozenRate` members in the [RemoteAudioStats](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_remote_audio_stats.html) class
- The `totalFrozenTime` and `frozenRate` members in the [RemoteVideoStats](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_remote_video_stats.html) class

#### Deprecated

- The `lowLatency` member in the [LiveTranscoding](https://docs.agora.io/en/Video/API%20Reference/cpp/structagora_1_1rtc_1_1_live_transcoding.html) class
...
- `onCameraReady`. Use LOCAL_VIDEO_STREAM_STATE_CAPTURING(1) in the [onLocalVideoStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a5a8bfdc3a7c4ba054f90365ed00781d6) callback instead.
- `onVideoStopped`. Use LOCAL_VIDEO_STREAM_STATE_STOPPED(0) in the [onLocalVideoStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a5a8bfdc3a7c4ba054f90365ed00781d6) callback instead.
- The `WARN_LOOKUP_CHANNEL_REJECTED(105)` warning code. Use CONNECTION_CHANGED_REJECTED_BY_SERVER(10) in the [onConnectionStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af409b2e721d345a65a2c600cea2f5eb4) callback instead.
- The `ERR_TOKEN_EXPIRED(109)` error code. Use CONNECTION_CHANGED_TOKEN_EXPIRED(9) in the [onConnectionStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af409b2e721d345a65a2c600cea2f5eb4) callback instead.
- The `ERR_INVALID_TOKEN(110)` error code. Use CONNECTION_CHANGED_INVALID_TOKEN(8) in the [onConnectionStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#af409b2e721d345a65a2c600cea2f5eb4) callback instead.
- The `ERR_START_CAMERA(1003)` error code. Use LOCAL_VIDEO_STREAM_ERROR_CAPTURE_FAILURE(4) in the [onLocalVideoStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a5a8bfdc3a7c4ba054f90365ed00781d6) callback instead.
- The `ERR_VDM_WIM_DEVICE_IN_USE(1502)` error code. Use LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY(3) in the  in the [onLocalVideoStateChanged](https://docs.agora.io/en/Video/API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine_event_handler.html#a5a8bfdc3a7c4ba054f90365ed00781d6) callback instead.
...
v2.3.2 adds the following methods, allowing you to use the external video during a call or in live interactive streaming:
...
See [Adjust the Volume](../../en/Video/volume_windows.md) for the scenarios and corresponding APIs.
...
-   Occasional audio issues during the live interactive streaming.
...
>  If you upgrade the SDK to v2.1.2 from a previous version, the video quality of the live interactive streaming will be better than the video quality of the call in the same resolutions, resulting in the live interactive streaming using more bandwidth.
...
In the live interactive streaming scenario, the host can enhance the local audio effects from the built-in microphone with the <code>setLocalVoiceEqualization</code> and <code>setLocalVoiceReverb</code> methods to implement the expected voice equalization and reverberation effects.
...
- Voice or Video Call: [Online Statistics Query API](../../en/API%20Reference/dashboard_restful_communication.md)
- Interactive Audio or Video Streaming: [Online Statistics Query API](../../en/API%20Reference/dashboard_restful_live.md)


##### 4. 17-way video

Adds the support of 17-way video in the live interactive streaming scenario


##### 5. Injecting an external video stream

Adds the function of injecting an external video stream to an ongoing interactive streaming. See [Inject Online Media Stream](../../en/Video/inject_stream_windows.md).
...
-   Adds the <code>onClientRoleChanged</code> callback to report on a user role switch between the host and audience in the live interactive streaming.
...
-   Web: Adds and updates a series of APIs to enable interoperability between the web browsers and native clients for the `COMMUNICATION` and `LIVE_BROADCASTING` profiles. See [Release Notes](../../en/Video/release_web_video.md).
