...
Before using the in-ear monitoring function, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](../../en/Video/start_call_audio_unity.md) or [Start Live Interactive Streaming](../../en/Video/start_live_audio_unity.md) for details.
