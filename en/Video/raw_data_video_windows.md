...
Before using the raw data functions, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](../../en/Video/start_call_windows.md) or [Start Interactive Video Streaming](../../en/Video/start_live_windows.md).
