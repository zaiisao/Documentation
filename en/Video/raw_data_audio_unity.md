...
Before using the raw audio data function, ensure that you have implemented the basic real-time communication functions in your project. See [Start a Voice Call](../../en/Video/start_call_audio_unity.md) and [Start a Voice Broadcast](../../en/Video/start_live_audio_unity.md) for details.
