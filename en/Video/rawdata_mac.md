...
description: 
platform: macOS
updatedAt: Fri Nov 09 2018 18:02:53 GMT+0000 (UTC)
---
# Modify Raw Data
...
The Agora raw data interface is a C++ interface. For all the APIs used on this page, refer to [Video Call API](https://docs.agora.io/en/Video/API%20Reference/oc/index.html).
