...
description: 
platform: iOS
updatedAt: Fri Sep 20 2019 02:14:34 GMT+0800 (CST)
---
# Release Notes
...
For more information on the implementation, API call sequence, sample code, and considerations, see [Co-host Across Channels](../../en/Video/media_relay_ios.md).
...
To ensure smooth communication, use the same parameter type to identify all users within a channel, that is, all users should use either the integer user ID or the string user account to join a channel. For details, see [Use String User Accounts](../../en/Video/string_ios.md).
