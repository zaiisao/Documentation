...
description: 
platform: Android
updatedAt: Mon Jul 06 2020 04:55:14 GMT+0800 (CST)
---
# Raw Video Data
## Introduction
...
Before using the raw data functions, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Video Call](../../en/Video/start_call_android.md) or [Start Interactive Video Streaming](../../en/Video/start_live_android.md).
...
We also provide an open-source  [Video encrypt](https://github.com/AgoraIO/Advanced-Video/tree/master/Android/sample-video-encrypt) demo project on GitHub. You can try the demo, or view the source code in the [`IAgoraMediaEngine.h`](https://github.com/AgoraIO/Advanced-Video/blob/master/Android/sample-video-encrypt/src/main/cpp/include/agora/IAgoraMediaEngine.h) file.
...
Refer to [Raw Audio Data](../../en/Video/raw_data_audio_android.md) if you want to implement the raw audio data function in your project.
