...
Before setting the audio profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](../../en/Video/start_call_audio_unity.md) or [Start a Voice Broadcast](../../en/Video/start_live_audio_unity.md).
