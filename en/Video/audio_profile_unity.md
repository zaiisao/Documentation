...
platform: Unity
updatedAt: Mon Jul 06 2020 10:22:16 GMT+0800 (CST)
---
...
Before setting the audio profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Voice Call](../../en/Video/start_call_audio_unity.md) or [Start Live Interactive Streaming](../../en/Video/start_live_audio_unity.md).
...
- [`SetAudioProfile`](https://docs.agora.io/en/Video/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#adc5817c5d668f631123a643817cf3059)

## Considerations

Call this method before calling the [`JoinChannelByKey`](https://docs.agora.io/en/Video/API%20Reference/unity/classagora__gaming__rtc_1_1_i_rtc_engine.html#a5997a90398afe355d4d509a2a83a9999) method.
