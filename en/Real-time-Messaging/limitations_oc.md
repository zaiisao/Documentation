...
description: 
platform: iOS,macOS
updatedAt: Wed Apr 29 2020 03:40:23 GMT+0800 (CST)
---
# RTM Limitations
...
The call limit is for one <code>AgoraRtmKit</code> instance. If an operation corresponds to multiple methods, the number of calls of an operation equals to the sum of calls of all corresponding methods in a specific period of time.
