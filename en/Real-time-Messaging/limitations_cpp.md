...
updatedAt: Tue Apr 28 2020 09:44:52 GMT+0800 (CST)
---
# RTM Limitations
...
The call limit is for one IRtmService instance. If an operation corresponds to multiple methods, the number of calls of an operation equals to the sum of calls of all corresponding methods in a specific period of time.
