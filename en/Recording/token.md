...
1. Sign up for a developer account at [Agora Dashboard](https://dashboard.agora.io/). See [Sign in and Sign up](../../en/Recording/sign_in_and_sign_up.md).
...
1. Enable the [App Certificate](../../en/Recording/token.md). 
...
The application client needs to send the following parameters to the server to generate a token. See [Generate a Token on Your Server](../../en/Recording/token_server.md).
